...
namespace PlantTrackerAPI.DataAccessLayer.Migrations
{
    ...
    [Migration("20210824132456_AddingPlantFamilyNameAtributeToPlantEntity")]
    partial class AddingPlantFamilyNameAtributeToPlantEntity
    {
            ...
            modelBuilder.Entity("PlantTrackerAPI.DomainModel.Plant", b =>
                {
                    ...
                    b.Property<string>("PlantFamilyName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PlantTrackerAPI.DomainModel.PlantNeed", b =>
                {
                    ...
                    b.Property<int>("MonthFromId")
                        .HasColumnType("int");

                    b.Property<int>("MonthToId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MonthFromId");

                    b.HasIndex("MonthToId");
            ...
            modelBuilder.Entity("PlantTrackerAPI.DomainModel.PlantNeed", b =>
                {
                    ...
                    b.HasOne("PlantTrackerAPI.DomainModel.Month", "MonthFrom")
                        .WithMany("PlantNeedsFrom")
                        .HasForeignKey("MonthFromId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PlantTrackerAPI.DomainModel.Month", "MonthTo")
                        .WithMany("PlantNeedsTo")
                        .HasForeignKey("MonthToId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
